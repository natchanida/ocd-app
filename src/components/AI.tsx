        ...
        <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          ...
          <div className=" lg:w-2/3 w-full">
            ...
            <p className="mb-8 leading-relaxed">
              ...
              <ol style={{ listStyleType: "dise" }} className="ml-4">
                <li>
                  ถ้าผลการพยากรณ์เป็น Iung_aca หมายความว่าเป็นโรคมะเร็งปอด aca
                </li>
                <li>
                  ถ้าผลการพยากรณ์เป็น Iung_n
                  หมายความว่าเป็นปกติไม่เป็นโรคมะเร็งปอด
                </li>
                <li>
                  ถ้าผลการพยากรณ์เป็น Iung_scc หมายความว่าเป็นโรคมะเร็งปอด scc
                </li>
              </ol>
            </p>
