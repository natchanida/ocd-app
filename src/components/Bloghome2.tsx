              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ปรัชญาการคิด
                      เชิงวิพากษ์เพื่อการเปลี่ยนแปลงและการพัฒนาองค์การในภาครัฐ
                    </p>
                    <a
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ลักษณะสำคัญขององค์การเพื่อการพัฒนาคุณภาพการบริหารจัดการภาครัฐในยุคดิจิทัลและ
                      AI
                    </p>
                    <a
